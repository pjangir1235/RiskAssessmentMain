...
public class ConsumerAircraftTypeValueConfig {
	...
	public ConsumerFactory<Integer, AircraftTypeDTO> aircraftTypeDataConsumerFactory() {
		...
		return new DefaultKafkaConsumerFactory<>(props, new IntegerDeserializer(),
		                new JsonDeserializer(AircraftTypeDTO.class));
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<Integer, AircraftTypeDTO> aircraftTypeDataKafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<Integer, AircraftTypeDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
