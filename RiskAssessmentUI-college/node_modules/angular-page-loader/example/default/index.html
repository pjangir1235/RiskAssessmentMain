		...
		<header>
			...
			<nav class="routes-container">
				<ul class="routes-list">
					<li class="route" ng-repeat="route in routesList"><a
						href="#{{route.originalPath}}" ng-bind="route.title"></a></li>
				</ul>
			</nav>
		</header>
...
<script type="text/javascript"
	src="https://ajax.googleapis.com/ajax/libs/angularjs/1.3.10/angular-route.min.js"></script>
<script type="text/javascript"
	src="../../dist/angular-page-loader.min.js"></script>
<script>
